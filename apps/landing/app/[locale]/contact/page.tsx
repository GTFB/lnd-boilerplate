      ...
      <div className="space-y-12">
        ...
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            У вас есть вопросы или предложения? Мы всегда рады помочь и обсудить
        ...
        <div>
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">
                  Как начать использовать LND Boilerplate?
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 dark:text-gray-400">
                  Клонируйте репозиторий, установите зависимости командой{' '}
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600 dark:text-gray-400">
                  Да, проект полностью написан на TypeScript с типизацией всех
                  компонентов и утилит.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600 dark:text-gray-400">
                  LND Boilerplate распространяется под MIT лицензией, что
                  позволяет использовать его в любых проектах, включая
                  коммерческие.
                </p>
              </CardContent>
            </Card>
