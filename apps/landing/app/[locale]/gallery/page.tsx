...
export default function GalleryPage() {
  ...
  const blogPosts = [
    {
      ...
      description:
        'Полное руководство по использованию системы изображений в проекте',
      coverImage:
    ...
    },
    {
      ...
      description:
        'Узнайте, как оптимизировать ваше приложение для максимальной производительности',
      coverImage:
      ...
      authorName: 'Jane Doe',
      authorAvatar:
        'https://images.unsplash.com/photo-1592621385612-4d7129426394?w=100&h=100&fit=crop&crop=face',
  ...
  const experts = [
    ...
    },
    {
      ...
      avatar:
        'https://images.unsplash.com/photo-1592621385612-4d7129426394?w=400&h=400&fit=crop&crop=face',
        ...
        <section>
          <div className="mb-8">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300">
              Демонстрация компонента ImageGallery с поддержкой lightbox и
              подписей
            </p>
          </div>
